...
function mostrarPrioridade(lead) {
  ...
  return (
    ...
    classePrioridade +
    "'>" +
    "<span class='prioridade-ponto'></span>" +
    prioridade +
    "</span>"
  );
}
...
function validarLevantamento(lead) {
  ...
  if (
    ...
    Number(lead.numeroColaboradores) <= 0
  ) {
...
function editarLead(id) {
  ...
  document.getElementById("editComercialResponsavel").value =
    lead.comercialResponsavel;
...
formLead.addEventListener("submit", function (event) {
  ...
  let numeroColaboradores = document.getElementById(
    "numeroColaboradores",
  ).value;
  ...
  let requisitosSeguranca = document.getElementById(
    "requisitosSeguranca",
  ).value;
...
formEditarLead.addEventListener("submit", function (event) {
  ...
  lead.numeroColaboradores = document.getElementById(
    "editNumeroColaboradores",
  ).value;
  ...
  lead.requisitosSeguranca = document.getElementById(
    "editRequisitosSeguranca",
  ).value;
